...
class DirectionsControllerTest < ActionController::TestCase
  ...
  test "should create direction" do
    assert_difference('Direction.count') do
      post :create, direction: { destination: @direction.destination, options: @direction.options, origin: @direction.origin, status: @direction.status }
    end
  ...
  test "should update direction" do
    patch :update, id: @direction, direction: { destination: @direction.destination, options: @direction.options, origin: @direction.origin, status: @direction.status }
    assert_redirected_to direction_path(assigns(:direction))
  end
